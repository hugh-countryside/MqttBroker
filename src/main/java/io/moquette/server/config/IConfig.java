...
//         BrokerConstants.DEFAULT_PERSISTENT_PATH);
        setProperty(BrokerConstants.PASSWORD_FILE_PROPERTY_NAME,"config/password_file.conf");
        setProperty(BrokerConstants.ALLOW_ANONYMOUS_PROPERTY_NAME, Boolean.FALSE.toString());
